...
knitr::opts_chunk$set(
  collapse = TRUE,
  comment = "#>",
  fig.path = "docs/reference/figures/shiny_app_files/"
)
```
...
knitr::include_graphics("./shiny_app_files/Overall_web_page.png")
```
...
knitr::include_graphics("./shiny_app_files/warning_CV.png")
```
...
sampleObj <-read.csv("./shiny_app_files/samplesheet_singleRep.csv", header = TRUE, sep = "\t")
...
knitr::include_graphics("./shiny_app_files/file_upload_image.png")
```
...
knitr::include_graphics("./shiny_app_files/blank_singlerep.png")
```

**Step 3: Enter Text Fields and Run Analysis!**

```{r echo=FALSE, out.width = '75%'}
knitr::include_graphics("./shiny_app_files/single_rep_fields.png")
```
...
knitr::include_graphics("./shiny_app_files/download_button.png")
```
...
# read in the qPCR data
sampleObj <-read.csv("./shiny_app_files/samplesheet_bioReps_2.csv", header = TRUE, sep = "\t")
...
```{r echo=FALSE, out.width = '75%'}
knitr::include_graphics("./shiny_app_files/bio_reps_blank.png")
```
...
```{r echo=FALSE, out.width = '75%'}
knitr::include_graphics("./shiny_app_files/bioreps_filled_fields.png")
```
...
# read in the qPCR data
sampleObj <-read.csv("./shiny_app_files/samplesheet_hkgStab.csv", header = TRUE, sep = "\t")
...
```{r echo=FALSE, out.width = '75%'}
knitr::include_graphics("./shiny_app_files/hkg_blank.png")
```

**Step 3: Enter Text Field and Run Analysis!**

```{r echo=FALSE, out.width = '75%'}
knitr::include_graphics("./shiny_app_files/hkg_filled_fields.png")
```
